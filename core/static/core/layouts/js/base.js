    ...
    modals.forEach(function (modal) {
        modal.addEventListener("show.bs.modal", function (event) {
            ...
            Object.keys(initial_form_data).forEach(function (field_name) {
                ...
                * the form: id_<field_name>, Be wary of pages might have duplicate IDs(it's invalid HTML), and to resolve
                ...
                * (country code & national number part). Besides creating two fields from one, It also modifies their ID's by
                * appending a 0 on country code field(phone_no_0) and a 1 on the national number field(phone_no_1).
                * However, they retain the parent field ID in their ID's i.e. phone_no
                */
                if (field_name === "phone_no") input_id = `${input_id}_1`; // Only fill the national number field
